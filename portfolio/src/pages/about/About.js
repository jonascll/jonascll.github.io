        ...
        <div>
            <div className="aboutContainer">
                <div className="aboutContent">
                    ...
                    <span className="aboutText">From a young age, I ventured into video game worlds and was always fascinated by computers. During my high school years, I learned I had a knack for logical and analytical problem-solving. Then, a teacher guided me towards a more IT-oriented education for my bachelor's, which is where I learned how to program. This then led me to apply these newly learned skills in game development. Every time I relax with some video games, I start reverse-engineering the mechanics in my head trying to figure out the code behind it. I'm also an avid gym goer. If I'm not at home experimenting with a new codebase, library, or framework, I'm at the gym releasing some stress.</span>
                </div>
