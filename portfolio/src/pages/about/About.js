        ...
        <div>
            ...
            <div className="aboutContainer">
                ...
                <div className="skillsetContainer">
                    <div className="iconRow">
                        <div className="icon">
                           ...
                           <BarGraph insideColor={"rgb(207, 241, 241)"} borderColor={"#363640"} progress={75} width={150} height={30} borderThickness={3} label="Proficient" labelColor={"#363640"}></BarGraph>
                        </div>
                        <div className="icon">
                        ...
                        <div className="icon">
                          ...
                          <BarGraph insideColor={"rgb(207, 241, 241)"} borderColor={"#363640"} progress={75} width={150} height={30} borderThickness={3} label="Competent" labelColor={"#363640"}></BarGraph>
                        </div>
                    </div>
                    <div className="iconRow">
                        <div className="icon">
                        ...
                        <div className="icon">
                            ...
                            <BarGraph insideColor={"rgb(207, 241, 241)"} borderColor={"#363640"} progress={75} width={150} height={30} borderThickness={3} label="Familiar" labelColor={"#363640"}></BarGraph>
                        </div>
                ...
                <div className="skillsetContent">
                    <h1 className="aboutHeader">What do i have in my arsenal?</h1>
                </div>
            </div>
        </div>
    )
